...
После внесения в файл новой информации, необходимо **_обязательно_** сохранить изменения, нажав сочетание клавиш, например, ```ctcl+S```.
...
```
Данная команда выполняет *снимок* текущего состояния файла, которому будет автоматически присвоен *уникальный номер*, а в комментарий в кавычках упростит навигацию в общем списке коммитов для последующего удобства работы с логом файла.
...
* сохранять изменения в файле: `ctcl+S`
...
Но если внести в файл новые данные и нажать `ctcl+S`, сохранив тем самым изменения а затем ввести команду `git diff`, то она отобразит все новые данные относительно прошлого коммита.

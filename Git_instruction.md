...
Подразумевается, что у вас установлена какая-либо программа - редактор исходного кода. Например, `Visual Studio Code`, версию для своей ОС можно скачать, перейдя по ссылке: [https://code.visualstudio.com/download](https://code.visualstudio.com/download) и установить на компьютер.

...
Для __*удаленной*__ работы существуют специальные сервисы, позволяющие интегрироваться с программий `Git` на Вашем компьютере и настроить удаленную работу с Вашими репозиториями.
